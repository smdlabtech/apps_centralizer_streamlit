...
images = [f"{image_folder}/img ({i}).JPG" for i in range(1, 5)]
...
carousel_items = [
    {"img": images[0], "caption": "Expenses Tracker", "title": "Expenses Tracker", "text": "Expenses Tracker", "url": "https://expensestrackerr.streamlit.app/"},
    {"img": images[1], "caption": "Professional Data Engineer Quizes", "title": "Professional Data Engineer Quizes", "text": "Professional Data Engineer Quizes", "url": "https://quizappdelpgcp.streamlit.app/"},
    {"img": images[2], "caption": "Analyse Immo-info", "title": "Analyse Immo-info", "text": "Analyse Immo-info", "url": "https://analyse-immo-info.streamlit.app/"},
    {"img": images[3], "caption": "Predicting the Creditworthiness of Bank Customers", "title": "Predicting the Creditworthiness of Bank Customers", "text": "Predicting the Creditworthiness of Bank Customers", "url": "https://cyclientscreditworthinesspyapp-dq6q6sm24bakhp34memfrr.streamlit.app/"},
]
